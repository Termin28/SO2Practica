...
PROGRAMS=mi_mkfs leer_sf escribir leer permitir truncar mi_ls mi_mkdir mi_chmod mi_stat mi_touch mi_escribir mi_escribir_varios mi_cat prueba_cache_tabla mi_link mi_rm mi_rmdir simulacion #verificacion
OBJS=$(SOURCES:.c=.o)
